...
public:
	...
	[[nodiscard]] static Point2D EquilateralThirdPoint(const Point2D& pointA, const Point2D& pointB,
		bool rotateCounterClockwise);

	[[nodiscard]] static Point2D FermatTorricelliPoint(const Point2D& pointA, const Point2D& pointB,
