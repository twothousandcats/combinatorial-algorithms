...
BoruvkaMstSolver::DisjointSetUnion::DisjointSetUnion(std::size_t elementCount)
	: m_parent(elementCount)
	  , m_rank(elementCount, 0)
{
...
void BoruvkaMstSolver::ConsiderEdgeForComponentMinima(std::vector<std::optional<UndirectedEdge> >& bestForRoot,
	int rootFirst, int rootSecond, const UndirectedEdge& edge)
{
